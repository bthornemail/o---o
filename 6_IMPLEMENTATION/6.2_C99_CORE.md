...
process_snub_transform(ptr, slot, rrggbbaa_word)
```

`process_snub_transform` applies the `0x7C00` truncation boundary and flattens `RRGGBBAA` provenance words into RGB SpectrumDOM fields.
